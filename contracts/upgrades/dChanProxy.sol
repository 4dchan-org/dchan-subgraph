...
import "./dChanProxyStorage.sol";

/**
 * @title dChan Proxy
 * @dev dChan Proxy contract used to delegate call implementation contracts and support upgrades.
 * This contract should NOT define storage as it is managed by dChanProxyStorage.
 * This contract implements a proxy that is upgradeable by an admin.
 * https://docs.openzeppelin.com/upgrades-plugins/1.x/proxies#transparent-proxies-and-function-clashes
 */
contract dChanProxy is dChanProxyStorage {
    /**
    ...
    /**
     * @dev Changes the admin of the proxy to the zero address, renouncing ownership of this proxy contract.
     *
     * NOTE: Only the admin can call this function.
     *
