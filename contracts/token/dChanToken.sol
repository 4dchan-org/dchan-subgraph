...
contract dChanToken is Context, IERC20, Ownable {
    ...
    string private _name = "Decentralized 4chan";
    string private _symbol = "DCHAN";
    ...
    address public uniswapV2Pair; //immutable uniswapV2Pair;
    ...
    constructor() {
        ...
        // Commented out for local testing- uncomment when testing on polygon
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _queryFee == 0) return;
